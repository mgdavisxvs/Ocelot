...
type BehaviorDetector interface {
	...
	Detect(peer *Peer, upSpeed, downSpeed int64) (bool, string)
}
...
func (a *mlAnomalyAdapter) Detect(peer *Peer, upSpeed, downSpeed int64) (bool, string) {
	b := &ml.PeerBehavior{
		...
		// TorrentSize left as 0 — disables the impossible_download check
		// until TorrentSize is tracked in the Torrent struct.
	}
