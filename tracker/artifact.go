...
const (
	ReplicaHealthy         ReplicationHealth = iota
	ReplicaUnderReplicated                   // alert: insufficient but above minimum
	ReplicaDegraded                          // page: below minimum threshold
	ReplicaUnavailable                       // critical: zero replicas
)
